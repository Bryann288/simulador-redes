...
RETOS_POR_MODULO = {
    "Cisco 860VAE": [
        ...
        },
        {
            ...
            "pasos": [
                {"prompt": "CISCO_AS100(config)#", "cmd": ["vlan 100"], "pista": "Crea la VLAN local con 'vlan 100'.", "explicacion": "Separa el dominio de difusión de la LAN local."},
                {"prompt": "CISCO_AS100(config-vlan)#", "cmd": ["exit", "ex"], "pista": "Sal del menú VLAN con 'exit'.", "explicacion": "Regresa a configuración global."},
                {"prompt": "CISCO_AS100(config)#", "cmd": ["interface Vlan100", "int vlan100"], "pista": "Entra a la SVI con 'interface Vlan100'.", "explicacion": "En switches/routers ISR la SVI es la interfaz L3 de la VLAN."},
                ...
                {"prompt": "CISCO_AS100(config-if)#", "cmd": ["switchport access vlan 100"], "pista": "Asocia la VLAN con 'switchport access vlan 100'.", "explicacion": "Conecta el puerto físico con la SVI L3."},
    ...
    "Teldat RS123": [
        ...
        },
        {
            ...
            "pasos": [
                ...
                {"prompt": "Config>", "cmd": ["add device eth-subinterface ethernet0/0 200"], "pista": "Crea la subinterfaz con 'add device eth-subinterface ethernet0/0 200'.", "explicacion": "Teldat exige crear explícitamente el dispositivo lógico subinterfaz."},
                {"prompt": "Config>", "cmd": ["network ethernet0/0.200", "net ethernet0/0.200"], "pista": "Edita la subinterfaz con 'network ethernet0/0.200'.", "explicacion": "Selecciona el adaptador lógico para edición."},
                ...
                {"prompt": "ethernet0/0.200 config>", "cmd": ["encapsulation dot1q 200", "encap dot1q 200"], "pista": "Activa etiquetado con 'encapsulation dot1q 200'.", "explicacion": "Conecta la subinterfaz con la VLAN 200 del switch."},
    ...
    "Datacom SW1/SW2": [
        {
            ...
            "pasos": [
                ...
                {"prompt": "DATACOM-SW1(config)#", "cmd": ["interface vlan 100", "int vlan 100"], "pista": "Crea la VLAN 100 con 'interface vlan 100'.", "explicacion": "Define la VLAN de acceso para la PC1."},
                {"prompt": "DATACOM-SW1(config-vlan)#", "cmd": ["set-member untagged ethernet 1/5"], "pista": "Pon el puerto 1/5 en Untagged: set-member untagged ethernet 1/5", "explicacion": "Asigna el puerto de acceso para la PC1."},
                {"prompt": "DATACOM-SW1(config-vlan)#", "cmd": ["exit", "ex"], "pista": "Sal con 'exit'.", "explicacion": "Retorna a configuración global."},
                ...
                {"prompt": "DATACOM-SW1(config-if)#", "cmd": ["switchport native vlan 100"], "pista": "Define el PVID nativo con 'switchport native vlan 100'.", "explicacion": "Asigna el PVID 100 para tramas de entrada sin etiqueta."},
